...
//   // ============ Constructors ==============
//   // Imu6DOF();
//   // Imu6DOF(const BMI088 &bmi088);   // Constructor with BMI088 parameter
//   Imu6DOF() : bmi088() {}
//   // ============ Public attributes ==============
...
//   // void filterIMUWarmup(unsigned long &current_time, unsigned long &prev_time, float dt) {
...
// // // Constructor definition with BMI088 parameter
// // Imu6DOF::Imu6DOF(const BMI088 &bmi) : bmi088(bmi) {
